...
from espnet2.enh.layers.skim import ConditionalSkiM
from espnet2.enh.separator.abs_separator import AbsSeparator


class CSkiMSeparator(AbsSeparator):
    ...
    def forward(
        ...
        processed = self.skim(feature,condition)  # B,T, N
