...
from espnet2.enh.kws_enhance_model import KWSEnhancementModel
from espnet2.enh.kws_encoder.fusion_model import conformer_fusioner
from espnet2.enh.loss.wrappers.kws_solver import KWSSolver
from espnet2.enh.loss.wrappers.fix_kws_solver import fix_KWSSolver
...
from espnet2.enh.separator.cskim_separator import CSkiMSeparator
...
fusioner_choices = ClassChoices(
    name="fusioner",
    classes=dict(conformer=conformer_fusioner)
)
...
class EnhancementTask(AbsTask):
    ...
    @classmethod
    # def build_model(cls, args: argparse.Namespace) -> ESPnetEnhancementModel or KWSEnhancementModel:
    def build_model(cls, args: argparse.Namespace):
        ...
        # 1. Build model
        if getattr(args, "model_name", "espnet") == "tskim":
            fusioner = fusioner_choices.get_class(args.fusioner)(**args.fusioner_conf)
            model = KWSEnhancementModel(
                encoder=encoder,
                separator=separator,
                decoder=decoder,
